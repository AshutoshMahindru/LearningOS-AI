...
REQUIRED = [
    ...
    "data/content_registry.json", "data/lab_status.json", "data/apprenticeship_controls.yaml",
    "learning_os/cli.py", "learning_os/mission_loader.py", "learning_os/mission_runner.py",
    "learning_os/gate_engine.py", "learning_os/storage.py", "learning_os/retrieval.py",
    "learning_os/content_router.py", "learning_os/prerequisite_graph.py", "learning_os/mission_context.py",
...
sources_path = ROOT / "data" / "source_registry.json"
content_path = ROOT / "data" / "content_registry.json"
