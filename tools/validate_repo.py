...
if lab_path.exists():
    ...
    expected_executable = [f"M{i:02d}" for i in range(1, 37)]
    ...
    if labs.get("repository_executable") != expected_executable:
        errors.append("repository executable lab inventory must be exactly M01..M36")
...
if errors:
    ...
    sys.exit(1)
print("Repository validation PASSED: 42 missions, M01-M36 executable labs, and canonical 253-node knowledge graph")
